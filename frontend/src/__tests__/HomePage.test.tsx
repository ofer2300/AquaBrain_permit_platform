...
describe('HomePage', () => {
  ...
  describe('Rendering', () => {
    it('renders without crashing', () => {
      ...
      const elements = screen.getAllByText(/Building Permit Platform/i); expect(elements.length).toBeGreaterThan(0);
    });
  ...
  describe('Accessibility', () => {
    it('has proper heading hierarchy', () => {
      ...
      const h3Elements = screen.getAllByRole('heading', { level: 3 }); const h3 = h3Elements[0];
  ...
  describe('Visual Elements', () => {
    ...
    it('call-to-action section includes description', () => {
      ...
      expect(screen.getByText(/הצטרף לאלפי/i)).toBeInTheDocument();
    });
  ...
  describe('Content Completeness', () => {
    ...
    it('has secondary heading', () => {
      ...
      const h3Elements = screen.getAllByRole('heading', { level: 3 }); expect(h3Elements.length).toBeGreaterThan(0);
    });
